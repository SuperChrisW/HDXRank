...
public:
  ...
  bool RigidUnitGeometryChanged() const {
    return rigidUnitGeometryChanged;
  }
  ...
  void globalTranslate( const Vec3& deltaCenter );
  void globalRotate( const Vec3& rotor, const Vec3& centerOfRotation );
  void clearState();
  ...
  void configureRigidUnits( const std::vector< std::vector<int> >& RUtoPlist_, int nP );
  void setRigidUnit( int ru, const std::vector<Vec3>& absolutePositions );
  void setRigidUnit( int ru, const std::vector<Vec3>& absolutePositions,
      const std::vector<int>& indices );
  void setRigidUnits( const std::vector<Vec3>& absolutePositions );
  void setRigidUnitsFromMeanPositions( const std::vector<Vec3>& meanPositions );
