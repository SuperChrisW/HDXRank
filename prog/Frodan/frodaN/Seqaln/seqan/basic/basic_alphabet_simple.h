 ...
 ============================================================================
  $Id: basic_alphabet_simple.h,v 1.1 2011/04/23 04:38:28 dwfarrel Exp $
 ==========================================================================*/
...
template <> struct BitsPerValue< Iupac > { enum { VALUE = 4 }; };
  ...
  struct _AminoAcidDNA {};
  typedef SimpleType<unsigned char, _AminoAcidDNA> AminoAcidDNA;
 
  template <> struct ValueSize< AminoAcidDNA > { enum { VALUE = 35 }; };
  template <> struct BitsPerValue< AminoAcidDNA > { enum { VALUE = 5 }; };
