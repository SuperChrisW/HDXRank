...
if __name__ == "__main__":
    ...
    parser.add_argument('-save', type=str, default='/home/lwang/models/HDX_LSTM/results/240918_GVP', help='Path to save the output results')
    ...
    training_args = {'num_hidden_channels': 10, 'num_out_channels': 20, 
            ...
            'use_extend': True, # use extra 2671 synthetic peptides with RFU in range [0.6, 1.0]
    }
